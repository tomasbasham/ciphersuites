...
func TestIsRecommended(t *testing.T) {
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if got := tt.cipherSuite.IsRecommended(); got != tt.want {
				t.Errorf("mismatch:\n  got:  %t\n  want: %t", got, tt.want)
			}
		})
	}
...
func TestIsSecure(t *testing.T) {
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if got := tt.cipherSuite.IsSecure(); got != tt.want {
				t.Errorf("mismatch:\n  got:  %t\n  want: %t", got, tt.want)
			}
		})
	}
...
func TestIsWeak(t *testing.T) {
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if got := tt.cipherSuite.IsWeak(); got != tt.want {
				t.Errorf("mismatch:\n  got:  %t\n  want: %t", got, tt.want)
			}
		})
	}
...
func TestIsInsecure(t *testing.T) {
	...
	for name, tt := range tests {
		...
		t.Run(name, func(t *testing.T) {
			...
			if got := tt.cipherSuite.IsInsecure(); got != tt.want {
				t.Errorf("mismatch:\n  got:  %t\n  want: %t", got, tt.want)
			}
		})
	}
